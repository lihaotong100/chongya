...
const dict = {
  en: {
    ...
    announcement: {
      ...
      title: 'A Letter to All BSC Loyal Builders',
      bannerCta: '📜 Read the Letter',
      backHome: '← Back to Home',
      signName: 'BSC Builders Who Never Quit',
      signDate: 'Written on the night BSC needed hope the most',
      hashtag: '#BSCLoyalBuildersAlliance',
      paragraphs: [
        'Fellow loyal builders of BSC, greetings.',
        'Right now, we are standing at the darkest valley of the entire chain. The market is bone-chillingly cold; the tide has receded, leaving wreckage everywhere. Since Binance officially stepped into the meme arena last year, we all charged into that wilderness with fire in our hearts — only to slam into the ice wall of the macro environment and the mudslide of "Chinese coins." The consensus we once wore with pride has somehow shattered into insults and division. Some chase hot spots begging for a single green candle, then turn around and hurl the sharpest words at He Yi, at CZ — we get it. It is the defiance that comes after accepting a losing bet, the most primal human impulse. Nothing hard to understand there.',
        'But shouldn\'t we also consider another side?',
        'The people we curse for "doing nothing right" have not left. The teams accused of "abandoning BSC" are still pushing code at dawn. The officials haven\'t shut down a single thing that needed doing — they simply chose silence. While being cursed by tens of thousands, they chose to finish the work first, then speak. Retail investors\' frustration is perfectly justified; every cent is hard-earned. The officials\' silence is not indifference either — it is the stubbornness of someone who keeps fixing the pipes while being yelled at. Neither side is wrong; it\'s just that mutual understanding in a valley is unbearably hard.',
        'But the harder things get, the less BSC can afford to be nothing but resentment. A battlefield where everyone only slashes at each other cannot retain a single real builder. The simplest truth in this space is: birds of a feather flock together. When positive voices rise again, when those who refuse to give up start lifting each other up, the grievances, the FUD, the passive-aggressive sarcasm that blanket the chain will be diluted bit by bit — that is the only cure for BSC\'s chronic illness.',
        'We all remember CZ going from not understanding memes to actively buying and trading dog coins, He Yi unable to stay silent any longer against the flood of DMs from builders, choosing to engage. From years of BSC\'s wild, unmanaged growth to Four, to Alpha, to the exclusive internal pools — every action contains the officials\' original intent: trust in the builders and their most honest bet on BSC. CZ once said Chinese communities lack unity — isn\'t that, too, an outburst born of caring too much? Love runs deep, criticism runs sharp, frustrated that iron won\'t become steel — we are all the same, it turns out. But we must recognize that in this cold, dark night, that original intent has not died — it lives in the infrastructure, in the quietly updated code, in the hands of every developer who got cursed and kept building. They haven\'t given up. So what about us?',
        'What BSC lacks most right now is not the next 100x coin. It is a faint glimmer of hope, a bugle call that makes the silent builders lift their heads again.',
        'Loyal ones, it is time to set the resentment aside and piece back together the confidence that was shattered by the insults. A true BSC builder doesn\'t just shout "faith" when the chart pumps — they are the fools who keep loosening the soil, sowing seeds, and watering this land even in the deepest cold. We don\'t need to throw in our principal and ape into something right now. We just need to fall back in — fall back into the posture a BSC loyalist should have: unbreakable, un-scatterable, always charging forward.',
        'No attacking. No tearing apart. No treating anyone as the enemy. Eyes forward only, like a duckling paddling for the first time — feet thrashing wildly underwater, body gliding steadily ahead. Let every interaction on Twitter become a clear, ringing "CHARGE"; let every person still standing here breathe in a long-overdue lungful of clean, positive air. Even if the whole world mocks BSC as ruins, we will stand on those ruins and tell the entire crypto world — BSC people have NOT scattered!',
        'We are not abandoned orphans. We are precisely the ones who walked with BSC through its lowest valley. The officials continue in silence; we hold the line in the open. The road from 300 million to 3 billion — we, all BSC loyalists, will fill it step by step with our own footprints.',
        'A faint hope gently pushes against the darkness before dawn. It is not on the candlestick chart — it is in the eyes of every builder who pulls out their heart again and refuses resentment. This is the last deep night before dawn; everything is preparing below the horizon. And we will be the first ones touched by the light — on the condition that we are still here, still charging.',
        'May every one of you still standing here fall back in line and keep moving forward.',
      ],
    },
    gallery: {
      eyebrow: 'Art Gallery',
      title: 'The Chongya ',
      titleGold: 'Gallery.',
      sub: 'Art, characters, and music from the CHONGYA universe.',
      tabImages: 'Images',
      tabVideos: 'Videos',
      tabMusic: 'Music',
      prev: 'Previous page',
  ...
  zh: {
    ...
    announcement: {
      ...
      bannerCta: '📜 阅读公告',
      backHome: '← 返回首页',
      signName: '永不退场的BSC建设者',
      signDate: '写于BSC最需要希望的那个深夜',
      hashtag: '#BSC死忠建设者联盟',
      paragraphs: [
        'BSC的死忠建设者们，见字如面。',
        '此刻，我们正站在整条链最幽暗的谷底。行情冷得刺骨，潮水退去，满地狼藉。自去年币安官方下场，大家揣着一团火冲进meme的旷野，却撞上了大环境的冰墙，撞上了"中文币"的泥石流。曾引以为傲的共识，不知何时却碎成谩骂与撕裂。有人一边追着热点乞求一根阳线，一边回过头，把最锋利的词刺向何一、刺向CZ——我们懂，这是愿赌服输后的不甘，是血肉之躯最本能的冲动，没什么不可理解。',
        '可是，我们是不是也该想想另一个侧面？',
        '那些被我们骂"不干人事"的人，并没有离开。那些被说"放弃BSC"的团队，凌晨还在推代码。官方没有关掉任何一个该做的事，只是他们选择了沉默——在被万人唾骂的时候，他们选择了先把事做完，再开口。散户的不甘天经地义，每一分钱都来之不易。官方的沉默也并非冷漠，那是一种扛着骂名继续修水管的倔强。两边都没有错，只是低谷里的互相理解，实在太难。',
        '但越是这种时候，BSC就越不能只剩下戾气。一个只会互砍的战场，留不住任何真正的建设者。这个圈子最朴素的真理是：物以类聚，人以群分。当正能量的声音重新响起，当那些不想认命的人开始互相打气，那些弥漫在链上的怨气、Fud、阴阳怪气，才会被一点一点稀释——这才是根治BSC链上恶疾的唯一解药。',
        '我们当然都记得CZ从一开始不理解meme，到主动购买参与土狗交易，何一不忍继续沉默应对那些纷至沓来建设者们的"骚扰"私信，选择主动互动。从数年来BSC放羊般的野蛮生长，到Four到alpha到独家内盘，所有的行动都暗含着官方的初心，那是对建设者们的信任，也是他们对BSC最诚实的赌注。CZ曾说过国人不够团结，这又何尝不像我们不甘服输后的冲激。爱之深，责之切，恨铁不成钢，我们彼此竟都一样。但，一定要认识到在这个寒冷的深夜，这份初心没有死——它在底层设施里，在默默更新的代码里，在每一个被骂了还继续做事的开发者手里。他们没有放弃，那我们呢？',
        'BSC现在最缺的，根本不是下一个百倍币，而是一丝隐约的希望，一声让沉默的建设者重新抬头的号角。',
        '死忠们，是时候把怨气收一收，把被骂碎的信心拼回来了。真正的BSC建设者，不是只在拉盘时高呼信仰，而是在深寒里依然愿意为这片土壤松土、播种、浇水的傻子。我们不需要马上掏出本金去冲什么，我们只需要归位——归位到一个打不垮、骂不散、永远向前冲的BSC死忠该有的样子。',
        '不攻击，不撕扯，不把任何人当成敌人。只盯住前方，像小鸭子第一次划水一样，脚下拼命扑腾，身子稳稳前行。让推上的每一次互动，都变成一声清澈的"冲"；让每一个还留在这里的人，都吸到一口久违的、干净的正能量空气。哪怕全世界都嘲笑BSC是废墟，我们也要在废墟上告诉整个加密世界——BSC人，没散！',
        '我们不是被遗弃的孤儿，我们恰恰正是陪着BSC走过最低谷的人。官方在沉默继续，我们在明处坚守。从3亿到30亿的那条路，我们全体BSC死忠就用脚步一步步填满。',
        '隐约的希望轻推黎明的黑暗。它不在K线上，它在每一个重新掏出真心、拒绝戾气的建设者眼睛里。这是黎明前最后的那个深夜，一切都在地平线下面准备着。而我们，将是第一批被光照到的人——前提是，我们还在，我们还冲。',
        '愿所有仍在此处的你，此刻归队，继续向前。',
      ],
    },
    gallery: {
